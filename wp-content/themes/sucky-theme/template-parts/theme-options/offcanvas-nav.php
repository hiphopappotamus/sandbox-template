...
$offcanvas_customize_button = $offcanvas_options_group['offcanvas_customize_button']; // true / false
...
<button <?php
 ...
 <?php
    if ($offcanvas_customize_button && !$offcanvas_icon) :
        echo $offcanvas_button_label;
    elseif ($offcanvas_customize_button && $offcanvas_icon) :
...
<?php if($offcanvas_responsive_activate) {?>
    ...
    <div class="d-<?php echo $offcanvas_breakpoints['value']; ?>-none <?php echo ($responsive_class); ?>
